...
if __name__ == "__main__":
    ...
    if choose == "拍照识鸟":
        ...
        st.info('为了处理突发性输电线路渉鸟故障，针对性地加装防鸟措施，:balloon:甄羽可为您识别涉鸟故障危害鸟种，以便为运维人员提供正确识鸟的工具。(请上传jpg格式的图片)') 
        #-------------------------------------------------------------------------#
        # 图片文件加载处
        #-------------------------------------------------------------------------#        
        ...
        st.info('为了处理突发性输电线路渉鸟故障，针对性地加装防鸟措施，:baby_chick:甄羽可为您识别涉鸟故障危害鸟种，以便为运维人员提供正确识鸟的工具。(请上传mp4格式的视频)') 
        #-------------------------------------------------------------------------#
        # 进度条
        #-------------------------------------------------------------------------# 
